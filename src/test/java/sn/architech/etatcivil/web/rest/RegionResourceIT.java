...
class RegionResourceIT {
     ...
     *
     * @see sn.architech.etatcivil.repository.search.RegionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().regionCode(DEFAULT_REGION_CODE).regionName(DEFAULT_REGION_NAME);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().regionCode(UPDATED_REGION_CODE).regionName(UPDATED_REGION_NAME);
        return region;
    }
    ...
    void putNewRegion() throws Exception {
        ...
        updatedRegion.regionCode(UPDATED_REGION_CODE).regionName(UPDATED_REGION_NAME);
    ...
    void fullUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.regionCode(UPDATED_REGION_CODE).regionName(UPDATED_REGION_NAME);
