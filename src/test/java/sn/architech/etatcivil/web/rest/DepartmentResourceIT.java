...
class DepartmentResourceIT {
    ...
    private static final Integer DEFAULT_DEPARTMENT_CODE = 1;
    private static final Integer UPDATED_DEPARTMENT_CODE = 2;
     ...
     *
     * @see sn.architech.etatcivil.repository.search.DepartmentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().departmentCode(DEFAULT_DEPARTMENT_CODE).departmentName(DEFAULT_DEPARTMENT_NAME);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().departmentCode(UPDATED_DEPARTMENT_CODE).departmentName(UPDATED_DEPARTMENT_NAME);
        return department;
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.departmentCode(UPDATED_DEPARTMENT_CODE).departmentName(UPDATED_DEPARTMENT_NAME);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentCode(UPDATED_DEPARTMENT_CODE).departmentName(UPDATED_DEPARTMENT_NAME);
