...
describe('Department e2e test', () => {
  ...
  it('should create an instance of Department', () => {
    ...
    cy.get(`[data-cy="departmentCode"]`).type('58201').should('have.value', '58201');

    cy.get(`[data-cy="departmentName"]`)
      .type('optical Executif Team-oriented', { force: true })
      .invoke('val')
      .should('match', new RegExp('optical Executif Team-oriented'));
