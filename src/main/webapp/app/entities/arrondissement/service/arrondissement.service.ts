...
export class ArrondissementService {
  ...
  public resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/arrondissements');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IArrondissement[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
